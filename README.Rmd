...
This repository contains automated data releases for `nflendzone`, published via GitHub Actions and Releases. You can download and analyze data using R, Python, or other modern tools.
...
> **Tip:**
> The `duckdbfs` approach allows truly lazy queries and is how our Shiny app on shinyapps.io works—keeping RAM usage low and only downloading filtered data as needed.
...
You can similarly load other datasets by substituting the tag and filename.
...
Data updates are triggered daily at 4 AM Eastern during the NFL season (September–February) via GitHub Actions in the `nflendzonePipeline` repo.
